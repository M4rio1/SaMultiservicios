    ...
    <nav className="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div className="container">
        <a className="navbar-brand img" href="/">
          <img src={logo} alt="SaMultiservicios" className="navbar-logo" />
        </a>
        <button
          ...
          <ul className="navbar-nav text-uppercase ms-auto nav-links font-inter ">
            ...
            <li class="paste-button nav-item">
              ...
              <div class="dropdown-content">
                <a
                  id="top"
                  href="https://declaraguate.sat.gob.gt/declaraguate-web/"
                  target="_blank"
                >
                  declaraguate
                </a>
                <a
                  id="middle"
                  href="https://portal.sat.gob.gt/portal/verificador-integrado/"
                  target="_blank"
                >
