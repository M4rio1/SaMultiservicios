...
function Contacto() {
  ...
  <section className='section-spacing container contact-section'>
    ...
    <div class="contact-info">
        ...
        <div className='contact-info-item'>
          <FontAwesomeIcon icon={faEnvelope} size="2x" className='icon-info'/>
          <span className='mx-2'><strong>Email:</strong> contacto@empresa.com</span>
        </div>
        <div className='contact-info-item'>
          <FontAwesomeIcon icon={faStreetView} size="2x" className='icon-info'/>
          <span className='mx-2'><strong>Ubicacion: </strong>Calle 123, 123 123 Ciudad, Estado</span>
        </div>
        <div className='contact-map'>
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d1107.0552994417626!2d-90.51322765815475!3d14.642151459634285!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1ses-419!2sgt!4v1734322275158!5m2!1ses-419!2sgt" 
            width="600" 
            height="450" 
            allowfullscreen="" 
            loading="lazy" 
