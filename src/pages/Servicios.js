...
import { faCommentsDollar, faLandmark, faReceipt, faShip } from '@fortawesome/free-solid-svg-icons';
...
function Servicios() {
  ...
  return (
    ...
    <div class="overlay bg-black/60">
			<div class="container">
				<h1 className="block antialiased tracking-normal cormorant-sc-bold text-3xl leading-tight text-white mt-8 font-black animate__animated animate__fadeInDown">SERVICIOS</h1>
			</div>
		</div>
    </div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="relative flex flex-col bg-clip-border bg-white text-gray-700 rounded-lg shadow-lg shadow-gray-500/10">
              <div className="p-6 px-8 text-center">
                ...
                <h3 class="block antialiased tracking-normal cormorant-sc-bold text-xl font-semibold mb-3 mt-3">Asesoria financiera y fiscal</h3>
          ...
          <div className="relative flex flex-col bg-clip-border bg-white text-gray-700 rounded-lg shadow-lg shadow-gray-500/10">
              <div className="p-6 px-8 text-center">
                ...
                <h3 class="block antialiased tracking-normal cormorant-sc-bold text-xl font-semibold leading-snug  mb-3 mt-3">Servicios Contables</h3>
                <div className='img-serv mb-3'>
          ...
          <div className="relative flex flex-col bg-clip-border bg-white text-gray-700 rounded-lg shadow-lg shadow-gray-500/10">
              <div className="p-6 px-8 text-center">
                <FontAwesomeIcon icon={faLandmark} size='2x' className='icon-serv'/>
                <h3 class="block antialiased tracking-normal cormorant-sc-bold text-xl font-semibold leading-snug mb-3 mt-3">Auditoría de estados financieros</h3>
                <div className='img-serv mb-3'>
          ...
          <div className="relative flex flex-col bg-clip-border bg-white text-gray-700 rounded-lg shadow-lg shadow-gray-500/10">
              <div className="p-6 px-8 text-center">
                ...
                <h3 class="block antialiased tracking-normal cormorant-sc-bold text-xl font-semibold leading-snug mb-3 mt-3">Tramites</h3>
                <div className='img-serv mb-3'>
          ...
          <div className="relative flex flex-col bg-clip-border bg-white text-gray-700 rounded-lg shadow-lg shadow-gray-500/10">
              <div className="p-6 px-8 text-center">
                <FontAwesomeIcon icon={faShip} size='2x' className='icon-serv'/>
                <h3 class="block antialiased tracking-normal cormorant-sc-bold text-xl font-semibold leading-snug mb-3 mt-3">Servicios aduaneros</h3>
                <div className='img-serv mb-3'>
        ...
        <div className='container mx-auto'>
          <div className='bt-lg'>
            <div className='text-cont'>
              <h3 className="block antialiased tracking-normal cormorant-sc-bold text-3xl text-left leading-tight text-white font-black mt-3">¿Buscas asesoramiento integral y personalizado?</h3>
              <p className='text-white font-inter text-left mt-3 mb-8 text-xl'>Contáctanos. Somos la solución perfecta para tus necesidades.</p>
