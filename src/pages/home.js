        ...
        <div className="bg-banner">
          <div className="overlay bg-black/60">
            <div className='container-home'>
              <h1 className="title-home animate__animated animate__fadeInLeft">ASESORIA CONTABLE Y FISCAL.</h1>
              <h2 className="subtitle-home animate__animated animate__fadeInLeft">Responsabilidad Puntualidad y confianza</h2>
