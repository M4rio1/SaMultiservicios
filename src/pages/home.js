      ...
      <div className="bg-banner">
        <div className="overlay bg-black/60">
          <div className="container-home">
            <h1 className="title-home cormorant-sc-semibold animate__animated animate__fadeInLeft">
              ASESORIA CONTABLE Y FISCAL.
            </h1>
            <h2 className="subtitle-home cormorant-sc-semibold animate__animated animate__fadeInLeft">
              Responsabilidad Puntualidad y confianza
            </h2>
            <p className="p-home animate__animated animate__fadeInLeft">
              Somos una firma especializada en ofrecer soluciones integrales a
              pequeñas y medianas empresas en Guatemala. Contamos con amplia
              experiencia en Auditoría, Servicios Contables, Impuestos Fiscales
              y Consultoría Financiera. Nuestro compromiso es ayudarte a
              optimizar tus procesos, garantizar el cumplimiento normativo y
              fortalecer la toma de decisiones estratégicas con un enfoque
              profesional, eficiente y personalizado.
            </p>
            <div className="btn1-container">
              <a href="/Servicios">
                <button className="btn1 animate__animated animate__fadeInUpBig">
                  {" "}
                  VER SERVICIOS
                </button>
              </a>
      ...
      <div className="section-mt bg-white px-4 pb-20 pt-4 ">
        <div className="container mx-auto container-mt-home">
            ...
            <div className="card-home relative flex flex-col bg-clip-border bg-white text-gray-700 rounded-lg shadow-lg shadow-gray-500/10 animate__animated animate__fadeInUp">
              <div className="p-6 px-8 text-center">
                <FontAwesomeIcon
                  ...
                  className="icon-serv"
                />
                <h2 class="block antialiased tracking-normal cormorant-sc-bold text-xl font-semibold leading-snug text-blue-gray-900 mb-2 mt-3">
                  Asesoria financiera y <br />
                  fiscal
                </h2>
                <p class="block antialiased font-inter text-base leading-relaxed font-normal text-blue-gray-600">
                ...
                <a href="/Servicios/asesoria-financiera">
                  <button className="btn-card-home font-inter">
                    Mas información
                  </button>
                </a>
              </div>
          ...
          <div className="mt-32 flex flex-wrap items-center">
            <div class="container">
              <div>
                <h2 class="block antialiased tracking-normal font-sans text-3xl leading-tight mb-8 text-center">
                  Porque elegirnos:
                </h2>
              </div>
              ...
              <div class="benefit-list">
                <div class="benefit-card">
                  ...
                  <p className="font-inter">
                    Siempre estarás al día con las leyes fiscales y contables,
                    eliminando riesgos legales.
                  </p>
                </div>
                <div class="benefit-card">
                  <FontAwesomeIcon
                  ...
                  <p className="font-inter">
                    Aumenta tus ingresos y reduce costos con nuestras
                ...
                <div class="benefit-card">
                  ...
                  <p className="font-inter">
                    Resolvemos tus dudas de manera ágil y ofrecemos soporte
                    constante.
                  </p>
                </div>
                <div class="benefit-card">
                  ...
                  <p className="font-inter">
                    Contabilidad, impuestos, auditoría y planeación financiera
                    en un solo lugar.
                  </p>
                </div>
              </div>
