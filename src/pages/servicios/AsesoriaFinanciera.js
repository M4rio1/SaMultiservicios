    ...
    return(
        ...
        <div className="bg-banner mb-12">
            <div class="overlay bg-black/60">
			    <div class="container">
				    <h2 className="font-sans text-3xl text-white mb-3 font-black">Asesoria financiera y fiscal</h2>
			    </div>
		    </div>
        </div>
            ...
            <div className="container mx-auto">
                ...
                <div className="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                    ...
                    <div className="mb-3 list-borde">
                        ...
                        <span className="mx-2">Auditoria a estados financieros.</span>
                    </div>
                    <div className="mb-3 list-borde">
