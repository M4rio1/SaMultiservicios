...
function AsesoriaFinanciera(){
      ...
      const datosServicios = {
        consultoria: {
          ...
          descripcion: "Ofrecemos soluciones contables y fiscales personalizadas para optimizar la gestión financiera de tu negocio, garantizando cumplimiento legal y mejor control de recursos.",
          lista: [
        ...
        defensaFiscal: {
          ...
          descripcion: "Te representamos en procesos fiscales y atendemos reparos con estrategias sólidas, protegiendo tus intereses y reduciendo riesgos legales.",
          lista: [
        ...
        auditoria: {
          ...
          descripcion: "Realizamos auditorías exhaustivas para garantizar la transparencia y precisión de tus estados financieros, impulsando la confianza de inversionistas y socios.",
          lista: [
        ...
        contable: {
          ...
          descripcion: "Nos encargamos de llevar tus registros contables al día, asegurando un control financiero efectivo para la toma de decisiones estratégicas.",
          lista: [
        ...
        impuestos: {
          ...
          descripcion: "Diseñamos estrategias fiscales ajustadas a tu actividad, minimizando costos tributarios y maximizando tus beneficios.",
          lista: [
        ...
        creditos: {
          ...
          descripcion: "Te ayudamos a identificar y gestionar opciones de crédito ideales para tus necesidades, fortaleciendo la liquidez y expansión de tu negocio.",
          lista: [
        ...
        estadosAuditados: {
          ...
          descripcion: "Preparamos y auditamos tus estados financieros con precisión profesional, mejorando tu acceso a financiamiento y oportunidades comerciales.",
          lista: [
                ...
                <div className="opt-serv antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                    <div className="opt">
                        <div className="mb-3 list-borde" onClick={() => manejarClick("consultoria")}>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-clipboard-data-fill" viewBox="0 0 16 16">
                            <path d="M6.5 0A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0zm3 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5z"/>
                            <path d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1A2.5 2.5 0 0 1 9.5 5h-3A2.5 2.5 0 0 1 4 2.5zM10 8a1 1 0 1 1 2 0v5a1 1 0 1 1-2 0zm-6 4a1 1 0 1 1 2 0v1a1 1 0 1 1-2 0zm4-3a1 1 0 0 1 1 1v3a1 1 0 1 1-2 0v-3a1 1 0 0 1 1-1"/>
                            </svg>
                            <span className="mx-2">Consultoría y asesoría tributaria y contable.</span>
                        </div>
                        <div className="mb-3 list-borde" onClick={() => manejarClick("defensaFiscal")}>
                            ...
                            <span className="mx-2">Defensa fiscal y atención de reparos.</span>
                        </div>
                        <div className="mb-3 list-borde" onClick={() => manejarClick("auditoria")}>
                        ...
                        <div className="mb-3 list-borde" onClick={() => manejarClick("contable")}>
                            <i class="bi bi-calculator-fill"></i>
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-calculator-fill" viewBox="0 0 16 16">
                            ...
                            <span className="mx-2">Procesamiento, control y actualización contable.</span>
                        </div>
                        <div className="mb-3 list-borde" onClick={() => manejarClick("impuestos")}>
                            ...
                            <span className="mx-2">Asesoria de impuestos que mas le convenga según actividad económica y giro del negocio.</span>
                        </div>
                        <div className="mb-3 list-borde" onClick={() => manejarClick("creditos")}>
                            <i class="bi bi-credit-card-fill"></i>
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-credit-card-fill" viewBox="0 0 16 16">
                            <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v1H0zm0 3v5a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7zm3 2h1a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1v-1a1 1 0 0 1 1-1"/>
                            </svg>
                            <span className="mx-2">Asesoría en linea de créditos.</span>
                        </div>
                        <div className="mb-3 list-borde" onClick={() => manejarClick("estadosAuditados")}>
