...
function ServiciosContables() {
  ...
  const datosServicios = {
    contribuyentes: {
      ...
      descripcion:
        "Ofrecemos asesoramiento especializado para pequeños contribuyentes y comerciantes, garantizando el cumplimiento de obligaciones fiscales y optimizando los procesos administrativos.",
      lista: [
    ...
    importadores: {
      ...
      descripcion:
        "Brindamos soporte contable y fiscal a importadores para que gestionen sus operaciones comerciales con total confianza y apego a la legislación vigente.",
      lista: [
    ...
    constructores: {
      ...
      descripcion:
        "Diseñamos soluciones fiscales y contables adaptadas a las necesidades del sector de la construcción, ayudando a gestionar recursos financieros y cumplir con la normativa del sector.",
      lista: [
    ...
    serviciosPro: {
      ...
      descripcion:
        "Ofrecemos servicios contables diseñados para profesionales independientes, ayudándolos a organizar sus finanzas y cumplir con sus responsabilidades tributarias.",
      lista: [
    ...
    SectorPrimario: {
      ...
      descripcion:
        "Apoyamos a productores del sector agropecuario con estrategias fiscales y contables que optimizan la rentabilidad de sus actividades.",
      lista: [
    ...
    PropiedadHorizontal: {
      ...
      descripcion:
        "Proporcionamos servicios de contabilidad y fiscalización para asociaciones, entidades sin fines de lucro y propiedades horizontales, adaptándonos a sus características particulares.",
      lista: [
    ...
    <>
      <div className="bg-banner mb-12">
        <div class="overlay bg-black/60">
          <div class="container">
            <h2 className="cormorant-sc-bold text-3xl text-white mb-3 mt-3 font-black animate__animated animate__fadeInDown">
              SERVICIOS CONTABLES
            </h2>
          </div>
        </div>
          ...
          <div className="opt-serv antialiased font-inter text-base leading-relaxed font-normal text-blue-gray-600">
            <div className="opt">
              <div
                ...
                onClick={() => manejarClick("contribuyentes")}
              >
                ...
                <span className="mx-2">
                  Pequeños contribuyentes, servicios y comerciantes.
                </span>
              </div>
              <div
                className="mb-3 list-borde"
                onClick={() => manejarClick("importadores")}
              >
                ...
                <span className="mx-2">
                  Importadores de vehículos y mercaderías.
                </span>
              </div>
              <div
                className="mb-3 list-borde"
                onClick={() => manejarClick("constructores")}
              >
              ...
              <div
                className="mb-3 list-borde"
                onClick={() => manejarClick("serviciosPro")}
              >
              ...
              <div
                className="mb-3 list-borde"
                onClick={() => manejarClick("SectorPrimario")}
              >
              ...
              <div
                className="mb-3 list-borde"
                onClick={() => manejarClick("PropiedadHorizontal")}
              >
                ...
                <span className="mx-2">
                  Propiedad Horizontal, Asociaciones y entidades no lucrativas.
                </span>
              </div>
            </div>
            <div
