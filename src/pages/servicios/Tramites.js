...
function Tramites(){
    ...
    const [detalles, setDetalles] = useState({
      ...
      const datosServicios = {
        AperturayCierre: {
          titulo: "Apertura y cierre de empresas individuales y sociedades anónimas.",
          descripcion: "Consultoría y asesoría tributaria y contable para optimizar tus finanzas.",
        },
        HabilitacionDeCodigos: {
          titulo: "Habilitaciones de códigos de importador y exportador.",
          descripcion: "Defensa fiscal efectiva y atención personalizada en reparos.",
        },
        HabilitacionDeLibros: {
          titulo: "Habilitaciones de libros contables ante la SAT y Registro Mercantil.",
          descripcion: "Auditorías detalladas a estados financieros para garantizar transparencia.",
        },
        ActualizacionesRTU: {
        ...
        Inscripciones: {
          ...
          descripcion: "Asesoría fiscal para elegir los impuestos más convenientes para tu negocio.",
        },
        Reglamentos: {
          titulo: "Reglamentos de trabajo",
          descripcion: "Orientación especializada para obtener y gestionar líneas de crédito.",
        },
                ...
                <div className="opt-serv antialiased font-inter text-base leading-relaxed font-normal text-blue-gray-600">
                    <div className="opt">
                        <div className="mb-3 list-borde" onClick={() => manejarClick("AperturayCierre")}>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-buildings-fill" viewBox="0 0 16 16">
                            <path d="M15 .5a.5.5 0 0 0-.724-.447l-8 4A.5.5 0 0 0 6 4.5v3.14L.342 9.526A.5.5 0 0 0 0 10v5.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V14h1v1.5a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5zM2 11h1v1H2zm2 0h1v1H4zm-1 2v1H2v-1zm1 0h1v1H4zm9-10v1h-1V3zM8 5h1v1H8zm1 2v1H8V7zM8 9h1v1H8zm2 0h1v1h-1zm-1 2v1H8v-1zm1 0h1v1h-1zm3-2v1h-1V9zm-1 2h1v1h-1zm-2-4h1v1h-1zm3 0v1h-1V7zm-2-2v1h-1V5zm1 0h1v1h-1z"/>
                            </svg>
                            <span className="px-2">Apertura y cierre de empresas individuales y sociedades anónimas.</span>
                        </div>
                        <div className="mb-3 list-borde" onClick={() => manejarClick("HabilitacionDeCodigos")}>
                            ...
                            <span className="px-2">Habilitaciones de códigos de importador y exportador.</span>
                        </div>
                        <div className="mb-3 list-borde" onClick={() => manejarClick("HabilitacionDeLibros")}>
                            ...
                            <span className="mx-2">Habilitaciones de libros contables ante la SAT y Registro Mercantil.</span>
                        </div>
                        <div className="mb-3 list-borde" onClick={() => manejarClick("ActualizacionesRTU")}>
                        ...
                        <div className="mb-3 list-borde" onClick={() => manejarClick("Inscripciones")}>
                        ...
                        <div className="mb-3 list-borde" onClick={() => manejarClick("Reglamentos")}>
                        ...
                        <div className="mb-3 list-borde" onClick={() => manejarClick("ResidenciaExtranjeros")}>
                        ...
                        <div className="mb-3 list-borde" onClick={() => manejarClick("CeseActividades")}>
